...
uint8_t EthernetFrame::getPriority() const
{
    return this->priority;
}

void EthernetFrame::setPriority(uint8_t priority)
{
...
void EthernetFrame::setPayload(const char * payload)
{
...
EthernetFrameDescriptor::EthernetFrameDescriptor() : omnetpp::cClassDescriptor("ieee_802_1_qci::EthernetFrame", "omnetpp::cPacket")
{
